...
using ENDPOINT_ASPNET_BANCO.Model; // Importa o namespace do Model
using ENDPOINT_ASPNET_BANCO.database; // Importa o namespace do DbContext
...
namespace ENDPOINT_ASPNET_BANCO.Controller
{
    [ApiController]
    [Route("[controller]")]
