...
using ASP_NET_CORE_1.Model; // Importa o namespace do Model
using ASP_NET_CORE_1.database; // Importa o namespace do DbContext
...
namespace ASP_NET_CORE_1.Controller
{
    [ApiController]
    [Route("[controller]")]
