...
document.getElementById('usuarioBtn').addEventListener('click', () => {
  document.querySelector('.container h1').textContent = "Cadastro de Usuarios";
  document.querySelector('.container form').style.display = "block";
  document.querySelector('#tabelaUsuarios').style.display = "block";
});
